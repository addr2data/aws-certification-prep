ex-008: Getting started with Snapshots
======================================
...
Next steps
----------
In `ex-009 <https://github.com/addr2data/aws-certification-prep/blob/master/exercises/ex-009_GettingStartedS3.rst>`_, we will get started with S3.
